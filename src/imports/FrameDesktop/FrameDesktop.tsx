import svgPaths from "./svg-4mwluzb7sj";

function Group3() {
  return (
    <div className="absolute h-[42.661px] left-[60.88%] right-[32.48%] top-[1102px]">
...
function Group() {
  return (
    <div className="-translate-y-1/2 absolute h-[42.62px] left-[27.95%] right-[69.22%] top-[calc(50%+525.31px)]">
...
function Group1() {
  return (
    <div className="[word-break:break-word] absolute contents font-['Inter:Bold',sans-serif] font-bold leading-[0] left-[632px] not-italic text-[25px] text-white top-[741px]">
      <div className="-translate-y-1/2 absolute flex flex-col h-[42px] justify-center left-[632px] top-[762px] w-[105px]">
        <p className="leading-[normal]">5:55 PM</p>
      </div>
      <div className="-translate-y-1/2 absolute flex flex-col h-[42px] justify-center left-[774px] top-[762px] w-[71px]">
...
function Group2() {
  return (
    <div className="absolute contents left-[528px] top-[834px]">
      <div className="absolute inset-[71.7%_66.64%_22.54%_27.95%]" data-name="Vector">
      ...
      <div className="[word-break:break-word] absolute font-['Instrument_Sans:Regular',sans-serif] font-normal h-[188px] leading-[0] left-[679.62px] text-[40px] text-white top-[834px] w-[596.378px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
export default function FrameDesktop() {
  return (
    <div className="bg-white relative size-full" data-name="frame - desktop">
      <div className="absolute h-[540px] left-0 top-[658px] w-[1889px]">
      ...
      <Group />
      <Group1 />
      <div className="absolute inset-[61.27%_68.29%_34.14%_27.95%]" data-name="Vector">
      ...
      <div className="absolute flex inset-[61.27%_32.45%_34.14%_63.79%] items-center justify-center" style={{ containerType: "size" }}>
